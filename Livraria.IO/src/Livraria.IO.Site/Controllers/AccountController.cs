...
using Livraria.IO.Infra.CrossCutting.Identity.Models;
using Livraria.IO.Infra.CrossCutting.Identity.Models.AccountViewModels;
using Livraria.IO.Infra.CrossCutting.Identity.Services;
...
namespace Livraria.IO.Site.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(ProdutosController.Index), "Produtos");
        }
